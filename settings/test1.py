...
czsc.set_url_token(token="cf0c365ec1ee99720ab22d139a7c6fa5904638eb35528317ff929649", url="https://api.tushare.pro")

# 也可以在初始化 DataClient 时设置 token；不推荐直接在代码中写入 token
# dc = czsc.DataClient(url="https://api.tushare.pro", cache_path=r"D:\.tushare_cache", token="your tushare token", timeout=300)
